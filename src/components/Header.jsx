    ...
    <header className="flex justify-between items-center px-8 py-4 bg-white border-b border-gray-100">
      ...
      <div className="relative w-1/3">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-[#F6F6F6] rounded-xl text-sm outline-none border-none"
        />
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-gray-100">
          ...
          <div className="text-right">
            <p className="text-sm font-bold text-[#2D3134]">
              Mersya Grande
            </p>
            <p className="text-[10px] text-[#A9A9A9] uppercase tracking-wider">
              Admin
            </p>
          </div>
